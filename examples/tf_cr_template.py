...
##    clean up auto generated terraform files - list all stacks worked on
...
edit ~/src2/bitbucket/terraform/edge/stacks/a104_05_edge_fortigate_configure_b/conf/addresses.yaml 
...
cd $HOME/src2/bitbucket/terraform/edge/stacks/$stack
    start_time=$(date)
    { time ./firewall_update.sh -t ~/bin/terraform_1.2.9 $action -no-color ; } 2>&1 | tee $log_file
    end_time=$(date)
...
#   if branch has not been merged, merge branch
